...
def load_and_check_features(instance):
    G = nx.read_gpickle(instance)
    is_good = check_features(G)
    return is_good, instance
...
if __name__ == '__main__':
    ...
    for instance, is_good in tqdm.tqdm(pool.imap_unordered(load_and_check_features, instances), total=len(instances)):
